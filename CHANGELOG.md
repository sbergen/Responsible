...
### Changed
- Classes, which were intended to be internal were marked as internal, some parameters renamed for better documentation. This is the only backwards non-compatible change, but is highly unlikely to have any practical impact.
...
### Changed
- Makes `...Seconds` operators use `double` instead of `int` (it just makes more sense)
